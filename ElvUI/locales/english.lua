...
L['Backdrop Alpha Percentage'] = true;
L["Class Power"] = true;
...
L['Use backdrop alpha setting for Custom Health or Class Backdrop.'] = true
...
L['The backdrop alpha percentage, when 1 no alpha blending is applied.'] = true;
