...
function RU:Initialize()
	local xOffset = -((E.eyefinity or E.UIParent:GetWidth() / 2) * .8)
	...
	RaidUtilityPanel:Point('TOP', E.UIParent, 'TOP', xOffset, 1)
	RaidUtilityPanel:SetFrameLevel(3)
	RaidUtilityPanel.toggled = false
	RaidUtilityPanel:SetFrameStrata("HIGH")

	--Show Button
	self:CreateUtilButton("ShowButton", E.UIParent, "UIMenuButtonStretchTemplate, SecureHandlerClickTemplate", 136, 18, "TOP", E.UIParent, "TOP", xOffset, 2, RAID_CONTROL, nil)
