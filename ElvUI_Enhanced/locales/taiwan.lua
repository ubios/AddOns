...
L["Your version of ElvUI is to old (required v5.48 or higher). Please, download the latest version from tukui.org."] = "您的ElvUI版本過低(需要 v5.48 或更高), 請前往tukui.org下載最新版本."
