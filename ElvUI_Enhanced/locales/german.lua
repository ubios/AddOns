...
L["Your version of ElvUI is to old (required v6.22 or higher). Please, download the latest version from tukui.org."] = "Ihre Version von ElvUI ist zu alt (erforderlich v6.22 oder höher). Bitte laden Sie die neueste Version von tukui.org."
