...
local ENH = E:NewModule('ENH', 'AceHook-3.0', 'AceEvent-3.0');

ENH.version = GetAddOnMetadata("ElvUI_Enhanced", "Version")

E.PopupDialogs["VERSION_MISMATCH"] = {
	text = L["Your version of ElvUI is to old (required v5.1 or higher). Please, download the latest version from tukui.org."],
	button1 = CLOSE,
	timeout = 0,
	whileDead = 1,	
	preferredIndex = 3,
...
if tonumber(E.version) < 5.10 then
